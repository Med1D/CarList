...
final class NewCarTableViewController: UITableViewController
{
	var currentCar: Car!
	var newCar: Car!
	...
	override func viewWillAppear(_ animated: Bool) {
		...
		navigationController.setGradient(size:
			CGSize(width: UIApplication.shared.statusBarFrame.width, height: UIApplication.shared.statusBarFrame.height + 110))
	}
	...
	func saveCar() {
		...
		if currentCar != nil {
			...
			newCar = storageManager.saveCar(model: modelTextField.text,
