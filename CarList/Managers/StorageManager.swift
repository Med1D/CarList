...
class StorageManager {
    ...
    func saveCar(model: String?, manufacturer: String?, bodyType: String?, yearOfManufacture: Date?, imageData: Data?) -> Car? {
        guard let carEntity = NSEntityDescription.entity(forEntityName: "Car", in: self.persistentContainer.viewContext) else { return nil }
